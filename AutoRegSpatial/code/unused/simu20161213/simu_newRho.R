...
for (i in 1:length(Ns))
{
  ...
  for (t in 1:length(Times))
  {
    ...
    for (r in 1:Nrep)
    {
      ...
      #Yt_krig1_true = kriging.typeI(Y_train, rhos_train, dist_train, dist_krig, 
      ...
      res0[,r] = c(mean((Yt_krig1_true - Y[krig_ind,Time])),
                   mean((Yt_krig2_true - Y[krig_ind,Time])),
                   mean((Yt_krig1 - Y[krig_ind,Time])),
                   mean((Yt_krig2 - Y[krig_ind,Time])))
      res[,r] = c(mean((Yt_krig1_true - Y[krig_ind,Time])^2),
                  mean((Yt_krig2_true - Y[krig_ind,Time])^2),
