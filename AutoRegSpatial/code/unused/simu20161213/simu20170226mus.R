...
source("infer_thetaE_func20170226.R")

Ns = c(100, 200, 400)
Times = c(200, 400, 800)

# betaE = 1; sig2E = 1.5
# betaX = 1.5; sig2X = 1; alpha = 0.5
# betaMu = 1.2; sig2Mu = 2; mu = 1

### strong spatial correlation
betaE = 1; sig2E = 2
betaX = 1; sig2X = 1; alpha = 0.5
betaMu = 1.5; sig2Mu = 1.5; mu = 1
...
save(estRes0, file = "../../data/simu/estExpStrong.rda")
...
for (i in 1:2)
{
  for (t in 1:2)
  {
    if (t==1) 
      ...
      cat(" & ")
    est = specify_decimal(sqrt(rowMeans((estRes0[[i]][[t]][[1]][c(1,3,4,6,7),] - theta_true)^2))*100, 1)
